...
import com.scheduler.service.IntervalService;
...
public class IntervalController {
    ...
    @GetMapping("/booked")
    @Operation(summary = "Get my booked intervals")
    public ResponseEntity<List<IntervalResponse>> getMyBookings(Authentication authentication) {
        UUID userId = UUID.fromString(authentication.getPrincipal().toString());
        List<IntervalResponse> response = intervalService.getMyBookings(userId);
        return ResponseEntity.ok(response);
    }
